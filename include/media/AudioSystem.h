...
public:
    ...
    enum audio_channels {
        ...
        CHANNEL_OUT_ALL = (CHANNEL_OUT_DEFAULT | CHANNEL_OUT_FRONT_LEFT | CHANNEL_OUT_FRONT_RIGHT |
                CHANNEL_OUT_FRONT_CENTER | CHANNEL_OUT_LOW_FREQUENCY | CHANNEL_OUT_BACK_LEFT | CHANNEL_OUT_BACK_RIGHT |
                CHANNEL_OUT_FRONT_LEFT_OF_CENTER | CHANNEL_OUT_FRONT_RIGHT_OF_CENTER | CHANNEL_OUT_BACK_CENTER),

        // input channels
        CHANNEL_IN_DEFAULT = 0x1,
        CHANNEL_IN_LEFT = 0x4,
        ...
        CHANNEL_IN_ALL = (CHANNEL_IN_DEFAULT | CHANNEL_IN_LEFT | CHANNEL_IN_RIGHT | CHANNEL_IN_FRONT | CHANNEL_IN_BACK|
